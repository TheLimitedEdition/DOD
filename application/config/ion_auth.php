...
$config['tables']['users_agency']    = 'users_agency';
$config['tables']['users_buyers']    = 'users_buyers';
$config['tables']['users_vendors']   = 'users_vendors';
 ...
 */
$config['site_title']                 = "LOCRM.com";       // Site Title, example.com
$config['admin_email']                = "goelvibhor4@gmail.com"; // Admin Email, admin@example.com
 ...
 */
$config['use_ci_email'] = TRUE; // Send Email using the builtin CI email class, if false it will return the code and the identity // Send Email using the builtin CI email class, if false it will return the code and the identity
$config['email_config'] = array(
'mailtype' => 'html', 'protocol' => 'smtp', 'smtp_host' => 'smtp.zoho.com', 'smtp_port' => 465 , 'smtp_timeout'=>'30', 'smtp_user' => 'support@locad.net', 'smtp_pass' => 'locad1234', 'charset' => 'utf-8', 'newline' => '\r\n',
);
